...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/renatopcinfo/',
  },
  {
    name: 'Slack',
    link: 'https://slack.renatopcinfo/',
  },  
  {
    name: 'Twitter',
    link: 'https://twitter.com/renatopcinfo',
  },  
];
        ...
        <div className="row">
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvidas e ou
              sugestões, só ir em algum de nossos links =)
              </P>
              <ALink
